...
namespace AquaFree2.Controllers
{
    public class VentasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Fecha,Numero,Total")] Venta venta)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Fecha,Numero,Total")] Venta venta)
        {
            if (id != venta.Id)
            {
                return NotFound();
